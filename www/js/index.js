...
setInterval(() => {
    ...
    window.tb.ajax.get('/api/room/get-room-state/1/users').then(res => console.log(res));
}, 1e3);
...
setTimeout(() => {
    window.tb.ajax.post('/api/room/set-user-room-state/1/privateUserId', {some_user_key: 11}).then(res => console.log(res));
}, 5e3);
